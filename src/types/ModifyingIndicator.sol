...
/// @dev Indicator for modifying user fields: Resolver, Ttl, Owner. See struct {INSUnified.ImmutableRecord}.
ModifyingIndicator constant USER_FIELDS_INDICATOR = ModifyingIndicator.wrap(0x38);
